...
\begin{frame}
  \titlepage
  \note{\scriptsize Sehr geehrte Damen und Herren, gesch\"atzte Kollegen,\\[0.5ex]
  als Masterstudent der Angewandten Physik freue ich mich, Ihnen heute in den n\"achsten 10 Minuten einen pr\"agnanten \"Uberblick \"uber die Wechselwirkungen geladener Teilchen mit Materie zu geben, ein fundamentales Feld, dessen theoretische Grundlagen die Basis f\"ur moderne Anwendungen von der Dosimetrie bis zur Hadronentherapie bilden.}
\end{frame}

\begin{frame}{Gliederung}
  \begin{itemize}
    \item Einleitung: aktuelle Relevanz und Aufh\"anger
    ...
    \item Makroskopische Konsequenzen: Bragg-Peak und Therapie
...
\begin{frame}{Einleitung: Relevanz}
  \begin{itemize}
    \item Pr\"azise Steuerung geladener Teilchen ist Kern moderner Medizinphysik.
    \item Hadronentherapie ben\"otigt millimetergenaue Platzierung des Bragg-Peaks.
    \item Theoretische Modelle des Bremsverm\"ogens sichern klinische Pr\"azision.
  \end{itemize}
...
\begin{frame}{Historischer Kontext}
  \begin{itemize}
    \item F\"ur schwere geladene Teilchen dominiert $S_{\text{col}}$ den Energieverlust.
    \item Bohrs klassische Theorie (1913) untersch\"atzte Daten um Faktor~2.
    \item Bethe (1931) f\"uhrte quantenmechanisch-relativistische Beschreibung ein.
  \end{itemize}
  \note{\scriptsize F\"ur schwere geladene Teilchen ist die Kollisionsbremskraft $S_{\text{col}}$ der dominierende Term. Die historische Entwicklung f\"uhrte von Bohrs klassischer Theorie (1913), die die Bindungseffekte nur rudiment\"ar ber\"ucksichtigte und experimentelle Daten um einen Faktor~2 untersch\"atzte, zu Bethes quantenmechanisch-relativistischer Theorie (1931).}
\end{frame}

\begin{frame}{Bethe-Gleichung}
  \begin{itemize}
    \item Trennung in $S_{\text{soft}}$ und $S_{\text{hard}}$ eliminiert willk\"urliche Grenze $\eta$.
    \item Resultierende Bethe-Mass-Collision-Stopping-Power-Gleichung f\"ur schwere Teilchen:
  \end{itemize}
  \begin{equation*}
...
\begin{frame}{Bragg-Peak: Mechanismus}
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.55\textwidth}
      \begin{itemize}
...
\begin{frame}{Klinische Relevanz der Hadronentherapie}
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.55\textwidth}
      \begin{itemize}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        ...
        \item Bethe-Formel koppelt Teilchenparameter mit Materialeigenschaften \"uber $I$.
...
\begin{frame}{Vielen Dank}
  \centering
  \Large Ich danke Ihnen f\"ur Ihre Aufmerksamkeit.\\[1ex]
  \normalsize Fragen?
  \note{\scriptsize Ich danke Ihnen f\"ur Ihre Aufmerksamkeit und stehe nun f\"ur Fragen zur Verf\"ugung.}
\end{frame}
